...
namespace ShipWar3
{
    class MatchMaker
    {
        ...
        {
            player1 = new PlayerProfile(player1Name, player1Type, null, 0,null,null);
            player2 = new PlayerProfile(player2Name, player2Type, null, 0, null,null);
            DefineShowingOfShips(ref player1, ref player2);
        }
        public void AskShipQuantity ()
        {
        ...
        public (int first,int second) GetResults()
        {
            return (player1.wins, player2.wins);
        }
        public void PlayGames(int quantity)
        {
            uiReference.QuantityOfShips(out shipQuantity);
